...
module storageAccount_blobServices 'blob-service/main.bicep' =
  if (!empty(blobServices)) {
    ...
    params: {
      ...
      automaticSnapshotPolicyEnabled: contains(blobServices, 'automaticSnapshotPolicyEnabled')
        ? blobServices.automaticSnapshotPolicyEnabled
        : false
      ...
      containerDeleteRetentionPolicyEnabled: contains(blobServices, 'containerDeleteRetentionPolicyEnabled')
        ? blobServices.containerDeleteRetentionPolicyEnabled
        : false
      containerDeleteRetentionPolicyDays: blobServices.?containerDeleteRetentionPolicyDays
      containerDeleteRetentionPolicyAllowPermanentDelete: contains(
          blobServices,
      ...
      deleteRetentionPolicyAllowPermanentDelete: contains(blobServices, 'deleteRetentionPolicyAllowPermanentDelete')
        ? blobServices.deleteRetentionPolicyAllowPermanentDelete
        : false
      deleteRetentionPolicyEnabled: contains(blobServices, 'deleteRetentionPolicyEnabled')
        ? blobServices.deleteRetentionPolicyEnabled
        : false
      ...
      lastAccessTimeTrackingPolicyEnabled: contains(blobServices, 'lastAccessTimeTrackingPolicyEnabled')
        ? blobServices.lastAccessTimeTrackingPolicyEnabled
        : false
...
module storageAccount_fileServices 'file-service/main.bicep' =
  if (!empty(fileServices)) {
    ...
    params: {
      ...
      shareDeleteRetentionPolicy: contains(fileServices, 'shareDeleteRetentionPolicy')
        ? fileServices.shareDeleteRetentionPolicy
        : {
            enabled: true
            days: 7
          }
